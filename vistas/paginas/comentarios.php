<section class="section1">
    <div>
        ...
        <div class="mandar_comentario">
            <form action="vistas/paginas/subir_comentario.php" method="post" class="form_comentario">
        ...
        <article class="contenedor_comentarios">
            <?php 
                $comentarios = fopen('vistas/paginas/archivo.txt', 'r');
                echo fread($comentarios,'5000');
            ?>
        </article>
    </div>
</section>
<?php include('vistas/paginas/include/nav.php'); ?>